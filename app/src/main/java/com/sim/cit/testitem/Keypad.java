...
public class Keypad extends TestActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(slideKeyReceiver, new IntentFilter("com.sim.action.slide_key"));
        //Modify for CIT optimization by xiasiping 20140730 start
    ...
    protected void onDestroy() {
        super.onDestroy();
        unregisterReceiver(slideKeyReceiver);
        //Modify for CIT optimization by xiasiping 20140730 start
        /*if (button_backlight_node != null) {
            Log.e(TAG,"xsp_button_backlight_node = " + button_backlight_node);
...
//			}
        ...
        case KeyEvent.KEYCODE_BRIGHTNESS_DOWN:
            changeColor("function_2");
            break;*/
        case KeyEvent.KEYCODE_MENU:
            changeColor("menu");
            break;
        case KeyEvent.KEYCODE_APP_SWITCH:
            changeColor("app_switch");
            break;
        case KeyEvent.KEYCODE_BACK:
            changeColor("back");
            break;
        case 260:
            changeColor("Slide_key");
            break;
        /*case KeyEvent.KEYCODE_PTT:
            changeColor("ptt");
            break;
        case KeyEvent.KEYCODE_SIDE_KEY:
            changeColor("Side_key");
            break;
  ...
  /*    case KeyEvent.KEYCODE_ALARM:
    ...
    private BroadcastReceiver slideKeyReceiver = new BroadcastReceiver() {

        @Override
        public void onReceive(Context context, Intent intent) {
            int value = intent.getIntExtra("action", 100);
            Log.i("Keypad","slideKeyReceiver intent.getStringExtra = [" +value + "]");
            if (value == 0) {
                changeColor("Slide_key_0");
