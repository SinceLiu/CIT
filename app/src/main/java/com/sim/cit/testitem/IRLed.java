...
public class IRLed extends TestActivity {	  
    ...
    private static final String FLASHLIGHT_NODE = "/sys/class/leds/ir-led-pwm/brightness";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_hint.setText(R.string.ir_confirm);
