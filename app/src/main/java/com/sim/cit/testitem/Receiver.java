...
public class Receiver extends TestActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            oldBrightValue = Settings.System.getInt(Receiver.this.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT);
        } catch (SettingNotFoundException e) {
            e.printStackTrace();
        }
        Settings.System.putInt(Receiver.this.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, Integer.MAX_VALUE -1);
    }
    ...
    protected void onDestroy() {
        ...
        Settings.System.putInt(Receiver.this.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, oldBrightValue);
    }
