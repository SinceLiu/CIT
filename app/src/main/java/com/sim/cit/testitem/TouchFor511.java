...
public class TouchFor511 extends TestActivity {
    ///udisk   or  /storage/udisk
    private static final String TAG = "CIT_Touch";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Touch.setText("Please choose the result of Touch");
        btnPass = super.btnPass;
        btnPass.setEnabled(false);
        i = new Intent(context, TPTest.class);
        btnTest = (Button)findViewById(R.id.btn_one);
        btnTest.setText("ReTest Touch");
