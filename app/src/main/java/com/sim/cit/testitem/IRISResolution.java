...
public class IRISResolution extends TestActivity {
    ///udisk   or  /storage/udisk
    private static final String TAG = "CIT_IRISResolution";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i.putExtra("type", "IRISResolution");
        btnTest = (Button)findViewById(R.id.btn_one);
        btnTest.setText("ReTest IRISResolution");
